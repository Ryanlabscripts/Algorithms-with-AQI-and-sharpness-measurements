function [xGM,QQ,lhSharp,resultImageOut]= CGLS_AQI_mk8(proj,geo,angles,lH,niter,Freewheel,sharp_line,sharp_start,sharp_RHe,varargin)
%
...
% xGM is the reconstruction result at the iteration having the greatest AQI
% value.
...
for ii=1:niter
    ...
    if (itFreewheel==0 && ii==n2Stop) || (itFreewheel==1 && ii==niter)
        ...
        T = table((1:niter)',tIterationResults,ii4MaxResults,n2StopResults,itStop,...
            ...
            {'Iteration','Iteration time','ii4Min','n2Stop','itStop','Sharpness','AQI'});
