...
for ii=1:niter
    ...
    if ii==1 % Set-up
        ...
        % initially set n2Stop to 125 (max value plus 25 more iterations
        % before STOP)
        n2Stop=125; 
        ...
        tOld=tTaken;
    elseif ii > 25 % Now check for current maximum of AQI and store x if necessary
        if QQ(ii) > QQmax
            QQmax=QQ(ii);
            resGM=res;
            ii4Max=ii;
            ...
            new_n2Stop=ii4Max+25; % Here assumed 25 more iterations before STOP
