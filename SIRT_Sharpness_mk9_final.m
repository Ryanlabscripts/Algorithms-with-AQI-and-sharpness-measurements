function [resGM,QQ,lhSharp,resultImageOut]=SIRT_Sharpness_mk9_final(proj,geo,angles,lH,niter,Freewheel,sharp_line,sharp_start,sharp_RHe,varargin)
%
...
% ===========================Revision of stopping rules====================================================================
    if ii==1 % Set-up
        ...
        if (lhSharp(ii) < 40)&&(ii>99)
            if max(lhSharp(ii-99:ii))==min(lhSharp(ii-99:ii))
                n2Stop=ii;
